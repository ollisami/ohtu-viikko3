...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.taulukkoSisaltaaLuvun(10));
        assertFalse(joukko.taulukkoSisaltaaLuvun(5));
        assertTrue(joukko.taulukkoSisaltaaLuvun(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.taulukkoSisaltaaLuvun(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.taulukkoSisaltaaLuvun(11));
        joukko.poista(11);
        assertFalse(joukko.taulukkoSisaltaaLuvun(11));
